...
public class SpawnBlock : Singleton<SpawnBlock>
{
    ...
    {
        spawnBlockData = Resources.Load<SpawnBlockData>("ScriptTableObject/Spawn Block Data");
        aBlock = spawnBlockData.aBlock;
        maxSizeBlock = spawnBlockData.maxSizeBlock;
        distanceBlock = spawnBlockData.distanceBlock;
    ...
    protected void CreateBlock(BlockStats blockStats, int? idPos = null)
    {
        ...
        if (blockStats.block == null)
        {
            ...
            {
                GameObject newBlock = Instantiate(aBlock, block.transform);
    ...
    protected BlockStats GetBlockStats()
    {
        ...
        newBlockStats.height = GetRandom(maxSizeBlock) + 1;
